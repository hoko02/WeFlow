...
## Purpose
Define the bounded single-Agent investigation loop that may use deterministic Replay or
an explicitly authorized command-local live provider, but cannot control workflow state
