# qq-sandbox-intake-and-ack Specification

## Purpose
Define the first bounded real QQ sandbox intake and fixed passive acknowledgement slice without enabling handler workflow, models, final delivery, or customer-success authority.
