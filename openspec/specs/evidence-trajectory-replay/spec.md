# evidence-trajectory-replay Specification

## Purpose
Define fixture-local, tenant-scoped, append-only evidence trajectories and deterministic
verification replay without granting execution authority.
