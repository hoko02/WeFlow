...
def create_app(
    ...
    *,
    ...
    app = FastAPI(
        ...
        version="0.2.0",
        description=(
            "Change 1 synthetic Case intake and diagnostics. "
            "No support-resolution workflow, approval, or external write is implemented."
        ),
    )
    ...
    def liveness() -> dict[str, object]:
        return _status_with_ledger(boundary, environment, repository_root)
    ...
    def readiness() -> JSONResponse:
        status = _status_with_ledger(boundary, environment, repository_root)
